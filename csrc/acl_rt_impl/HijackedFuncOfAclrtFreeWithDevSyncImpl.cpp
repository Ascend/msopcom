...
HijackedFuncOfAclrtFreeWithDevSyncImpl::HijackedFuncOfAclrtFreeWithDevSyncImpl()
    : HijackedFuncType(AclRuntimeLibName(), "aclrtFreeWithDevSyncImpl") {}

void HijackedFuncOfAclrtFreeWithDevSyncImpl::Pre(void *devPtr) {
    this->devPtr_ = devPtr;
    if (IsSanitizer()) {
...
aclError HijackedFuncOfAclrtFreeWithDevSyncImpl::Call(void *devPtr) {
    ...
    ERROR_LOG("HijackedFuncOfAclrtFreeWithDevSync originfunc is nullptr.");
